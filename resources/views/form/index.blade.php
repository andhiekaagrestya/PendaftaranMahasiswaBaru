        ...
        <form action="{{route('pendaftaran')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <input name="tempat_lahir" class="form-control" type="text" required><br>
                </div>
                <div class="col">
                ...
                <div class="col">
                    <label>Tempat lahir diluar negeri</label>
                    <input name="tempat_lahir_wna" class="form-control" type="text"><br>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col">
                    <label>Jika WNA Sebutkan Negaranya</label>
                    <input name="negara_wna" class="form-control" type="text"><br>
                </div>
            </div>
...
$('#provinsi').change(function() {
    ...
    if (provinsiId) {
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(data, function(key, value) {
                    $('#kabupaten').append('<option value="' + value.id + '">' + value.nama +
                        '</option>');
                });
            }
        });
        ...
        $('#kabupaten').empty();
        $('#kabupaten').append('<option value="">Pilih Kabupaten Kosong</option>');
    }
});
...
$('#provinsi_lahir').change(function() {
    ...
    if (provinsiId) {
        ...
        $('#kabupaten_lahir').empty();
        $('#kabupaten_lahir').append('<option value="">Pilih Kota Kosong</option>');
    }
});
</script>
