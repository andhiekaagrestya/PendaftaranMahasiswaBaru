...
<div class="container border rounded-3 p-2 my-4">
    ...
    <div class="container">
        <form action="{{route('dataPendaftar.tambahProses')}}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <textarea name="alamat_sekarang" id="alamat_sekarang" rows="5" class="form-control" required></textarea><br>
                </div>
            </div>
            ...
            <div class="row my-5">
                <div class="col">
                    <a class="btn btn-outline-danger" href="{{route('dataPendaftar.index')}}" style="width: 80px;">Back</a>
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        $('#kota').append('<option value="' + value.nama + '">' + value.nama +
                            '</option>');
                    });
                }
            });
        ...
        if (provinsiId) {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        $('#kota_lahir').append('<option value="' + value.nama + '">' + value
                            .nama +
                            '</option>');
                    });
                }
